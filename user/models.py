...
class UserLook(models.Model):
    ...
    用户查看历史
    """
    user_id = models.IntegerField(max_length=5, null=False, verbose_name='用户id')
    count = models.IntegerField(max_length=5, null=False, verbose_name='次数')
    goods_id = models.ForeignKey(Goods, max_length=5, on_delete=models.CASCADE, null=False, verbose_name='商品id')
    add_time = models.DateTimeField(auto_now_add=True, verbose_name='添加时间')
